                      ...
                      <div className="space-y-3">
                        ...
                        {members.length < 10 && (
                          <motion.button
                            ...
                            onClick={addMember}
                            className="w-full py-3 rounded-xl border-2 border-dashed border-white/10 hover:border-brand/40 hover:bg-brand/5 text-white/20 hover:text-brand/60 transition-all flex items-center justify-center gap-2 group"
                          >
                            <Plus className="w-4 h-4 group-hover:scale-110 transition-transform" />
                            <span className="text-sm font-bold">添加新队员 ({members.length}/10)</span>
                          </motion.button>
                        )}
                      </div>
                    </motion.div>
